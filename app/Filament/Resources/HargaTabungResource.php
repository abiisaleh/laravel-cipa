...
use App\Filament\Resources\HargaTabungResource\Pages;
use App\Filament\Resources\HargaTabungResource\RelationManagers;
use App\Filament\Resources\HargaTabungResource\RelationManagers\TabungRelationManager;
...
class HargaTabungResource extends Resource
{
    protected static ?string $model = HargaTabung::class;
    ...
    {
        return [
            'index' => Pages\ListHargaTabungs::route('/'),
            'create' => Pages\CreateHargaTabung::route('/create'),
            'edit' => Pages\EditHargaTabung::route('/{record}/edit'),
        ];
    }
}
