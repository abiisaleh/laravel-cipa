            ...
            <div class="order-2 md:order-1 mr-auto place-self-center text-center md:text-left lg:col-span-7 mx-auto">
                ...
                <div class="md:flex">
                    ...
                    <a href="{{ filament()->getLoginUrl() }}"
                        class="btn-shadow btn-shadow-white transition-all ease-in-out block mt-2 w-full md:w-auto md:mt-0 md:inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-full hover:bg-gray-100 focus:ring-4 focus:ring-gray-100">
                        Masuk
                    </a>
                </div>
