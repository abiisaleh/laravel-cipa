<x-layouts.app>
    <section class=" min-h-[80vh]">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 h-[80vh]">
            <div class="mr-auto place-self-center text-center md:text-left lg:col-span-7">
                ...
                <a href="{{ filament()->getRegistrationUrl() }}"
                    class="shadow-lg hover:shadow-none inline-flex items-center justify-center px-6 py-3 mr-3 text-base font-medium text-center text-white rounded-full bg-primary-600 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300">
                    Ayo gabung!
        ...
        <div class="absolute top-0 right-0 -z-10 w-[90vh] h-[90vh] bg-primary-100 rounded-bl-full"></div>
    </section>
</x-layouts.app>
